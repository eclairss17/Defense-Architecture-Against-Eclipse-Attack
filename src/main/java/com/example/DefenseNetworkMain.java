...
public class DefenseNetworkMain extends AbstractActor {
    ...
    private DefenseNetworkMain(Integer numberOfNodes, int percentageAttacker, int percentageVictim) {
        // super(context);
        //#create-actors
        ...
        for(int i = 0; i < numberOfNodes; i++){
            ...
            allNodes.put(i, getContext().actorOf(Props.create(DefenseNode.class, i, isAttacker, this.attackerRange, this.victimRange, true, timeToLive,triedPeers, testedPeers)));
        }
        for(int i =0; i < numberOfNodes; i++){
